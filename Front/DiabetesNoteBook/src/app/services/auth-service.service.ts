...
import { IUserLoginResponse } from '../interfaces/IUsuario.interface';
...
export class AuthServiceService {
  ...
  constructor(private http: HttpClient) {
    ...
    this.currentUserSubject = new BehaviorSubject<IUserLoginResponse | null>(JSON.parse(localStorage.getItem('user') || '{}'));
  ...
  loginUser(datoLogin: ILogin) : Observable<IUserLoginResponse> {
    return this.http.post<IUserLoginResponse>(`${this.API_URL}/Users/login`, datoLogin)
