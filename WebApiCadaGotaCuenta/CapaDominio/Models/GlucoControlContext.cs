...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=desktop-berg797;Initial Catalog=GlucoControl;Integrated Security=True;Pooling=False;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Medicione>(entity =>
        {
            ...
            entity.HasOne(d => d.IdPersonaNavigation).WithMany(p => p.Mediciones)
                ...
                .HasConstraintName("FK__Medicione__Id_Pe__628FA481");
        });
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__tmp_ms_x__3214EC07A3B6B60D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__tmp_ms_x__3214EC0786ECD0F9");
